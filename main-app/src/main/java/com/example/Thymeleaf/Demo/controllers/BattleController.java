...
public class BattleController {
    ...
    @Value("${BATTLE_SERVICE_URL:http://localhost:8081/battles}")
    ...
    public String initiateBattle(@RequestParam int fighter1Id,
        ...
        try {
            // Make the HTTP POST to the configurable battle service URL
            Map<String, Object> battleResult = restTemplate.postForObject(battleServiceUrl, request, Map.class);
